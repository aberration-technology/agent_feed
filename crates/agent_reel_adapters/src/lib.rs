...
"#;
    ...
    fn claude_stream_json_normalizes_display_safe_events() {
        let stream = r#"
{"type":"system","subtype":"init","session_id":"claude-1","cwd":"/home/mosure/repos/agent_reel","model":"claude-sonnet-4-6"}
...
"#;
    ...
    fn claude_hook_json_normalizes_permission_events() {
        let stream = r#"
{"hook_event_name":"SessionStart","session_id":"claude-2","cwd":"/home/mosure/repos/agent_reel","source":"startup","model":"claude-sonnet-4-6"}
