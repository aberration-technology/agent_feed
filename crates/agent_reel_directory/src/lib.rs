use agent_reel_core::HeadlineImage;
use agent_reel_identity::{GithubLogin, GithubUserId, IdentityError};
...
use agent_reel_p2p_proto::{
    ...
    Signature, Signed, StoryCapsule, StoryKind, feed_topic, github_user_topic, stable_digest,
};
...
impl NetworkSelector {
    ...
    pub fn network_id(&self) -> NetworkId {
        match self {
            Self::Mainnet => "agent-reel-mainnet".to_string(),
...
impl FeedDirectoryEntry {
    ...
    pub fn new(
        ...
        Self {
            ...
            live_topic,
            snapshot_protocol: "/agent-reel/1/snapshot".to_string(),
            last_seen_at: now,
...
mod tests {
    ...
    use agent_reel_p2p_proto::StoryCapsule;
