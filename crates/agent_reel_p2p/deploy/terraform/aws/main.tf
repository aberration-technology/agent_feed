...
locals {
  ...
  agent_reel_install_source         = lower(trimspace(var.agent_reel_install_source))
  ...
  edge_service_unit = templatefile("${path.module}/templates/agent-reel-edge.service.tftpl", {
    edge_loopback_port = var.edge_loopback_port
  })
  user_data = templatefile("${path.module}/templates/user-data.sh.tftpl", {
    agent_reel_crate_version   = var.agent_reel_crate_version
    agent_reel_git_ref         = var.agent_reel_git_ref
    agent_reel_git_repository  = var.agent_reel_git_repository
    agent_reel_install_source  = local.agent_reel_install_source
